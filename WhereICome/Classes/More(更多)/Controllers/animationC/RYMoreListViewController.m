//
//  RYMoreListViewController.m
//  WhereICome
//
//  Created by 安松林 on 15/6/30.
//  Copyright (c) 2015年 上海睿予科技有限公司. All rights reserved.
//

#import "RYMoreListViewController.h"

@interface RYMoreListViewController ()

@end

@implementation RYMoreListViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.view.backgroundColor = [UIColor whiteColor];
    self.navigationItem.title = _moreTitle;
